...
/// Página para pesquisar membros da CLAUDIA
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _buildInfo(
                    '1º Contato Emergência',
                    membro.primeiroContatoEmergencia ?? '-',
                  ),
                  _buildInfo(
                    '2º Contato Emergência',
                    membro.segundoContatoEmergencia ?? '-',
                  ),
                  ...
                  _buildInfo(
                    'Data do Batizado',
                    _formatarData(membro.dataBatizado),
                  ),
                  _buildInfo('Padrinho', membro.padrinhoBatismo ?? '-'),
                  _buildInfo('Madrinha', membro.madrinhaBatismo ?? '-'),
                  _buildInfo(
                    'Data Jogo de Orixá',
                    _formatarData(membro.dataJogoOrixa),
                  ),
                  _buildInfo(
                    '1ª Camarinha',
                    _formatarData(membro.primeiraCamarinha),
                  ),
                  _buildInfo(
                    '2ª Camarinha',
                    _formatarData(membro.segundaCamarinha),
                  ),
                  _buildInfo(
                    '3ª Camarinha',
                    _formatarData(membro.terceiraCamarinha),
                  ),
                  _buildInfo(
                    'Data Coroação Sacerdotal',
                    _formatarData(membro.dataCoroacaoSacerdote),
                  ),
                  _buildInfo(
                  ...
                  _buildInfo(
                    'Adjuntó do 1º',
                    membro.adjuntoPrimeiroOrixa ?? '-',
                  ),
                  _buildInfo('2º Orixá', membro.segundoOrixa ?? '-'),
                  _buildInfo(
                    'Adjuntó do 2º',
                    membro.adjuntoSegundoOrixa ?? '-',
                  ),
