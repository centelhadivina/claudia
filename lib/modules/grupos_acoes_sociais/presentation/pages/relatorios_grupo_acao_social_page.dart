...
/// Página para gerar relatórios de grupos de ações sociais
/// Disponível para níveis 2 e 4
class RelatoriosGrupoAcaoSocialPage extends StatefulWidget {
  const RelatoriosGrupoAcaoSocialPage({super.key});

  @override
  State<RelatoriosGrupoAcaoSocialPage> createState() =>
      _RelatoriosGrupoAcaoSocialPageState();
}

class _RelatoriosGrupoAcaoSocialPageState
    extends State<RelatoriosGrupoAcaoSocialPage> {
  final grupoAcaoSocialController = Get.find<GrupoAcaoSocialController>();

  String? grupoAcaoSocialFiltro;
  String? funcaoFiltro;

  List<GrupoAcaoSocialMembro> resultados = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Relatórios de Grupos de Ações Sociais'),
            ...
            child: ListView(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  initialValue: grupoAcaoSocialFiltro,
                  ...
                  onChanged: (v) => setState(() => grupoAcaoSocialFiltro = v),
                ),
                                ...
                                child: SingleChildScrollView(
                                  child: DataTable(
                                    columns: const [
                                      ...
                                      DataColumn(
                                        label: Text('Grupo de Ação Social'),
                                      ),
  ...
  void _gerarRelatorio() {
    setState(() {
      resultados = grupoAcaoSocialController.filtrar(
        grupoAcaoSocial: grupoAcaoSocialFiltro,
        funcao: funcaoFiltro,
      );
